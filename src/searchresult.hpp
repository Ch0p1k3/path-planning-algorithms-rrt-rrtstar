...
struct SearchResult {
  ...
  SearchResult(const double time_, const size_t countOfEdges_,
               const bool pathFound_, const double distance_,
  ...
  SearchResult(const SearchResult& other) {
    SearchResult(other.time, other.countOfEdges, other.pathFound,
                 other.distance, other.path);
  }
